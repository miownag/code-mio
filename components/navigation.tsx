    ...
    >
      <AnimatePresence mode="wait">
        {!isScrolled ? (
          ...
          >
            {navItems.map((item) => (
              <Link key={item.name} href={item.href} onClick={handleClick}>
                <motion.div
                ...
                >
                  {hoverItem === item.name && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-linear-to-b from-primary to-transparent"
                      transition={{
                        type: "spring",
                        stiffness: 380,
                        damping: 30,
                  ...
                  <span
                    className={cn(
                      "relative z-10 pixel-font text-2xl",
                  ...
                  {navItems.map((item, index) => (
                    ...
                    >
                      <motion.div
                        ...
                        className={cn(
                          "relative px-4 py-2.5 text-xl font-medium transition-colors rounded-lg cursor-pointer pixel-font",
